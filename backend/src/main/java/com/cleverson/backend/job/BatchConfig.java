package com.cleverson.backend.job;
...
import com.cleverson.backend.entity.TransacaoCNAB;

@Configuration
public class BatchConfig {

    @SuppressWarnings("unused")
    private static final JobLauncher JobLauncher = null;
    ...
    Step step(
            ...
            ItemProcessor<TransacaoCNAB, Transacao> prossor,
    ...
    FlatFileItemReader<TransacaoCNAB> reader(@Value("#{jobParameters['cnabFile']}") Resource resource) {
        return new FlatFileItemReaderBuilder<TransacaoCNAB>()
                ...
                // "/home/cjcleverson/Desenvolvimento/Spring-boot/spring-batch/backend/files/CNAB.txt"))
                .fixedLength()
